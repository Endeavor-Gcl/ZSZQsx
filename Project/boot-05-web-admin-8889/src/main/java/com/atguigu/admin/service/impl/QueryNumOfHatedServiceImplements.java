...
import com.atguigu.admin.service.QueryNumOfHatedService;
...
@Service
public class QueryNumOfHatedServiceImplements implements QueryNumOfHatedService {
    @Autowired
    StringRedisTemplate redisTemplate;


    public NumberResponseData queryNumOfHatedService(Set<String> userName, int pageNum, int pageSize) {
